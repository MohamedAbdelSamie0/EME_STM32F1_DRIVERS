...
/******************* IRQ_id i.e. Position In Vector Table ***********************/
/******  STM32F10xxx specific IRQ Numbers ******/
typedef enum
{
  ...
  DMA2_Channel4_5_IRQn		  = 59,		/*	DMA2 Channel4 global interrupt	*/
} IRQn_t;
...
uint8 NVIC_u8GetActiveFlag(IRQn_t IRQ_n);
